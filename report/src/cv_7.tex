...
Sur ces deux niveaux, une simulation sur toutes les positions inoccupées sur l'ensemble des règles générées sur les deux modèles

On considère que le modèle Alloy est lancé pour 25 instances d'objets au maximum
